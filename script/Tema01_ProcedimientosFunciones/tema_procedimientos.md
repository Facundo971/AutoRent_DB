...
-Se pueden crear diferentes tipos de funciones en SQL Server: escalares (devuelven un valor único), con valores de tabla de múltiples instrucciones y de tabla en línea (devuelven una tabla)
